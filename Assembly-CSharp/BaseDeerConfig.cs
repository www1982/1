...
{
	// Token: 0x0600030F RID: 783 RVA: 0x00017590 File Offset: 0x00015790
	public static GameObject BaseDeer(string id, string name, string desc, string anim_file, string traitId, bool is_baby, string symbolOverridePrefix = null)
	{
		...
		int num3 = global::TUNING.CREATURES.SORTING.CRITTER_ORDER["WoodDeer"];
	...
	// Token: 0x06000310 RID: 784 RVA: 0x00017908 File Offset: 0x00015B08
	...
	{
		return new Diet.Info(new HashSet<Tag> { foodTag }, poopTag, caloriesPerKg, producedConversionRate, diseaseId, diseasePerKgProduced, false, Diet.Info.FoodType.EatPlantDirectly, false, null);
	}

	// Token: 0x06000311 RID: 785 RVA: 0x00017934 File Offset: 0x00015B34
